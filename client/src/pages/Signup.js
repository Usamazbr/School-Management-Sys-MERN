...
const Signup = () => {
  ...
  const apiUrl = `http://localhost:5005/api/user/signup`;
  ...
  return (
    <div className="flex flex-row h-150">
      ...
      >
        <h3 className="m-2 text-xl font-bold text-slate-300">Signup</h3>
        ...
        <button
          className="m-auto mt-2 p-2 hover:bg-slate-400 hover:text-purple-900 rounded-lg"
          disabled={loadState}
        >
          Signup
        </button>
